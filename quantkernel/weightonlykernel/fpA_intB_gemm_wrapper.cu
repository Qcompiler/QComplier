...
#include "fpA_intB_gemm_interface.h"
                                      ...
                                      cudaStream_t stream)
{
    ...
    if(use_cuda_kernel){
        ...
        tensorrt_llm::kernels::weight_only::KernelType mCudaKernelType  = tensorrt_llm::kernels::weight_only::KernelType::FP16Int8PerChannel;
        void const* cuda_kernel_act_ptr = reinterpret_cast<const void *>(input);
        void const* cuda_kernel_weight_ptr = reinterpret_cast<const void *>(weight_ptr);
        void const* cuda_kernel_scales_ptr = reinterpret_cast<const void *>(scale);
        void* cuda_kernel_out_ptr = reinterpret_cast<void *>(output);
        tensorrt_llm::kernels::weight_only::Params params(cuda_kernel_act_ptr, nullptr, cuda_kernel_weight_ptr,
            cuda_kernel_scales_ptr, nullptr, nullptr, cuda_kernel_out_ptr, 1.f, m, n, k, 0, mCudaKernelType);
